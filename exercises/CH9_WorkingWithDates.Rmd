...
# no printed output: this only loads packages
...
```{r}
# no printed output: this creates linelist, see the Environment pane
...
```{r eval=F}
# no output here: example only, not run
...
```{r, }
# no printed output: this only loads a package
...
```{r}
# no printed output: this adds hour_admit and time_period to linelist, see the Environment pane
linelist <- linelist %>%
...
```{r, }
# no printed output: this creates example_date, see the Environment pane
